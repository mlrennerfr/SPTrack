function [res]=reconnectfast(path,file,maxblink,distmax,mintrace,handles,waitbarhandle)
% function [res]=reconnectfast(path,file,maxblink,distmax,mintrace,handles,waitbarhandle)
...
%
% MR oct 2007 -  for SPTrack.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% load file
[namefile,rem]=strtok(file,'.');
if handles.contrc==0
   TRCfile=[path,'\tr3\',namefile,'.trc'];
elseif handles.contrc==1
   TRCfile=[path,'\tr3\',namefile,'.con.trc'];
end
...
while reconnect==1 % iteration while it is possible do reconnections
  control=0; 
  for i=1:maxspots
       candidats=[];
