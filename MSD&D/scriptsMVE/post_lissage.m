...
%==================================================
%ecriture de 2 fichiers des temps de résidence : 1 pour peri=extra et 1 pour peri=syn dans le cas élimination du blink après lissage
% et de 2 fichiers aussi pour les pourcentages
%sauvegarde du fichier des temps à la synapse ou hors synapse wk1 pour
%peri=syn
%=============================================================
ind_type=1;
...
%%xlswrite([fn(1:length(fn)-4),'_peri=syn_post_lissage=',num2str(w),'.xls'],M,1,1);
%sheet = 1;
%xlRange = 'A1';
%xlswrite([fn(1:length(fn)-4),'_peri=syn_post_lissage=',num2str(w),'.xls'],M);
%cd(current_dir);
clear M nb_ligneM
